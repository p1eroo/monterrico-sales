export function MarketingAreaSvgIcon({ className }: { className?: string }) {
  return (
    <svg
      className={className}
      ...
      aria-hidden
    >
      <path d="M67 709.3l470 212 420-210-494.4-166.6z" fill="#3ED6FF" />
      <path d="M431.8 809.3l-230-99v-561l230 60z" fill="#37BBEF" />
      <path d="M431.8 809.3l220-100v-551l-220 51z" fill="#2481BA" />
      <path d="M201.8 149.3l230 60 220-51-234.4-55.6z" fill="#3ED6FF" />
      <path
      ...
      <path d="M535.5 451.2l139.9 41 120-47L651 411.6z" fill="#3ED6FF" />
      <path
