  ...
  return (
    <button
      ...
      className={cn(
        ...
        variant === 'compact'
          ? cn(
              'border-0 bg-amber-50/70 px-4 py-3',
              'hover:bg-amber-50',
              'dark:bg-amber-950/30 dark:hover:bg-amber-950/45',
              'focus:outline-none focus-visible:bg-amber-50 dark:focus-visible:bg-amber-950/45',
            )
          : cn(
    ...
    >
      <div
        className={cn(
          ...
          'dark:bg-amber-900/55 dark:text-amber-400',
          variant === 'full' && 'ring-1 ring-amber-200/80 dark:ring-amber-700/40',
        )}
      >
