  ...
  return (
    <main
      ...
      className={cn(
        ...
        "md:peer-data-[variant=inset]:m-2 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:border md:peer-data-[variant=inset]:border-border/70 md:peer-data-[variant=inset]:shadow-[0_10px_28px_rgba(0,0,0,0.22)] md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ml-2",
        className
      )}
      style={style}
      {...props}
  ...
  return (
    <Tooltip open={isCollapsedDesktop ? tooltipOpen : undefined}>
      ...
      <TooltipContent
        ...
        className={cn(
          "min-w-0 rounded-2xl border border-sidebar-border bg-sidebar px-2 py-2 text-sm text-sidebar-foreground shadow-[0_12px_40px_rgba(0,0,0,0.22)]",
          tooltipClassName,
        )}
        {...restTooltipProps}
      >
        {tooltipChildren ?? (
          <span className="flex items-center px-2 py-1 font-normal whitespace-nowrap text-sidebar-foreground">
            {tooltipLabel}
          </span>
        )}
      </TooltipContent>
