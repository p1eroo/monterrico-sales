...
function TableHeader({ className, ...props }: React.ComponentProps<"thead">) {
  return (
    <thead
      ...
      className={cn(
        "border-b-0 bg-background text-muted-foreground [&_tr]:border-b",
        className
      )}
      {...props}
    />
...
function TableRow({ className, ...props }: React.ComponentProps<"tr">) {
  return (
    <tr
      data-slot="table-row"
      className={cn(
        "border-b border-transparent transition-colors hover:bg-muted/50 data-[state=selected]:bg-background/90",
        className
      )}
      {...props}
    />
