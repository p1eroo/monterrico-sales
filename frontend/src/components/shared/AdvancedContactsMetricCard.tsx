...
interface AdvancedContactsMetricCardProps {
...
export function AdvancedContactsMetricCard({
  data,
  loading,
  className,
  info,
  onMaximize,
  maximizeDisabled,
}: AdvancedContactsMetricCardProps) {
      ...
      <CardContent className="flex min-h-[320px] flex-col p-5">
        <div className="flex min-h-8 items-center justify-between gap-2">
          ...
          <Button
            ...
            aria-label="Ampliar contactos avanzados"
          >
