      ...
      <div className="flex items-center gap-6">
        ...
        {onPageSizeChange && pageSize != null && (
          <div className="flex items-center gap-2">
            ...
            >
              <SelectTrigger size="sm" className="h-8 w-[75px] bg-background">
        ...
        <div className="flex items-center gap-1.5">
          <Button
            ...
            className="h-8 px-3 text-xs font-normal border-border/80 text-foreground hover:bg-muted/40 bg-background"
          >
            Anterior
          </Button>
              ...
              <Button
                ...
                className={`h-8 w-8 p-0 text-xs rounded-md ${
                  isPageActive
                    ...
                    : 'font-normal border-border/80 text-foreground hover:bg-muted/40 bg-background'
                }`}
              >
                {num}
              </Button>
