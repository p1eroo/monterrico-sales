...
const rawContacts: Omit<Contact, 'etapaHistory'>[] = [
  ...
  { id: 'l6', name: 'Patricia Huamán', cargo: 'Gerente Administrativa', companies: leadCompanies('Universidad PUCP', 'educacion', 'B', 'pucp.edu.pe'), phone: '+51 967 890 123', email: 'phuaman@pucp.edu.pe', source: 'base', etapa: 'negociacion', assignedTo: 'u2', assignedToName: 'María García', estimatedValue: 35000, createdAt: '2026-02-10', nextAction: 'Ajustar propuesta de precios', nextFollowUp: '2026-03-06', tags: ['educación'] },
  { id: 'l7', name: 'Ricardo Flores', cargo: 'Consejero', companies: leadCompanies('Embajada de España', 'diplomatico', 'A', 'embespana.pe'), phone: '+51 978 901 234', email: 'rflores@embespana.pe', source: 'referido', etapa: 'activo', assignedTo: 'u3', assignedToName: 'José Ramírez', estimatedValue: 85000, createdAt: '2026-01-20', nextAction: 'Iniciar servicio', nextFollowUp: '2026-03-01', tags: ['diplomático', 'premium'], clienteRecuperado: 'si' },
  { id: 'l8', name: 'Carmen Aguilar', cargo: 'Supervisora de Compras', companies: leadCompanies('Cencosud Perú', 'retail', 'B', 'cencosud.com.pe'), phone: '+51 989 012 345', email: 'caguilar@cencosud.com.pe', source: 'masivo', etapa: 'cierre_perdido', assignedTo: 'u4', assignedToName: 'Ana Torres', estimatedValue: 28000, createdAt: '2026-01-15', nextAction: 'Archivar', nextFollowUp: '', tags: ['retail'] },
  { id: 'l9', name: 'Diego Sánchez', cargo: 'Gerente de Flota', companies: leadCompanies('Telefónica del Perú', 'telecomunicaciones', 'A', 'telefonica.pe'), phone: '+51 990 123 456', email: 'dsanchez@telefonica.pe', source: 'entorno', etapa: 'lead', assignedTo: 'u5', assignedToName: 'Roberto Silva', estimatedValue: 72000, createdAt: '2026-03-03', nextAction: 'Contactar por WhatsApp', nextFollowUp: '2026-03-07', tags: ['telecomunicaciones'] },
  { id: 'l10', name: 'Valentina Rojas', cargo: 'Gerente de Servicios', companies: leadCompanies('Interbank', 'banca', 'A', 'interbank.pe'), phone: '+51 911 234 567', email: 'vrojas@interbank.pe', source: 'feria', etapa: 'contacto', assignedTo: 'u1', assignedToName: 'Carlos Mendoza', estimatedValue: 95000, createdAt: '2026-03-02', nextAction: 'Enviar brochure ejecutivo', nextFollowUp: '2026-03-06', tags: ['banca', 'corporativo'], clienteRecuperado: 'si' },
  { id: 'l11', name: 'Andrés Paredes', cargo: 'Director de Compras', companies: leadCompanies('Southern Copper Corp', 'mineria', 'A', 'southerncopper.com'), phone: '+51 922 345 678', email: 'aparedes@southerncopper.com', source: 'referido', etapa: 'reunion_agendada', assignedTo: 'u2', assignedToName: 'María García', estimatedValue: 150000, createdAt: '2026-02-22', nextAction: 'Preparar propuesta ejecutiva', nextFollowUp: '2026-03-07', tags: ['minería', 'premium'] },
  { id: 'l12', name: 'Gabriela Luna', cargo: 'Coordinadora de Viajes', companies: leadCompanies('LATAM Airlines Perú', 'aviacion', 'B', 'latam.com'), phone: '+51 933 456 789', email: 'gluna@latam.com', source: 'base', etapa: 'reunion_efectiva', assignedTo: 'u3', assignedToName: 'José Ramírez', estimatedValue: 48000, createdAt: '2026-02-18', nextAction: 'Coordinar prueba piloto', nextFollowUp: '2026-03-08', tags: ['aviación', 'transporte'] },
