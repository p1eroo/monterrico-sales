...
export const users: User[] = [
  { id: 'u1', name: 'Carlos Mendoza', email: 'carlos.mendoza@taximonterrico.com', role: 'admin', roleId: 'r1', phone: '+51 999 111 222', status: 'activo', contactsAssigned: 45, opportunitiesActive: 12, salesClosed: 28, conversionRate: 62, joinedAt: '2023-01-15', lastActivity: '2026-03-06T14:30:00' },
  { id: 'u2', name: 'María García', email: 'maria.garcia@taximonterrico.com', role: 'gerente', roleId: 'r2', phone: '+51 999 333 444', status: 'activo', contactsAssigned: 38, opportunitiesActive: 9, salesClosed: 22, conversionRate: 58, joinedAt: '2023-03-20', lastActivity: '2026-03-06T11:15:00' },
  { id: 'u3', name: 'José Ramírez', email: 'jose.ramirez@taximonterrico.com', role: 'asesor', roleId: 'r3', phone: '+51 999 555 666', status: 'activo', contactsAssigned: 32, opportunitiesActive: 7, salesClosed: 18, conversionRate: 56, joinedAt: '2023-06-10', lastActivity: '2026-03-06T09:45:00' },
  ...
  { id: 'u5', name: 'Roberto Silva', email: 'roberto.silva@taximonterrico.com', role: 'asesor', roleId: 'r3', phone: '+51 999 999 000', status: 'activo', contactsAssigned: 25, opportunitiesActive: 5, salesClosed: 12, conversionRate: 48, joinedAt: '2024-01-15', lastActivity: '2026-03-06T08:00:00' },
  { id: 'u6', name: 'Lucía Fernández', email: 'lucia.fernandez@taximonterrico.com', role: 'asesor', roleId: 'r3', phone: '+51 998 111 222', status: 'inactivo', contactsAssigned: 15, opportunitiesActive: 2, salesClosed: 8, conversionRate: 53, joinedAt: '2024-03-01', lastActivity: '2026-02-15T10:00:00' },
];
...
const rawContacts: Omit<Contact, 'etapaHistory'>[] = [
  ...
  { id: 'l16', name: 'Roberto Díaz', cargo: 'Gerente Comercial', companies: leadCompanies('Scotiabank Perú', 'banca', 'A', 'scotiabank.pe'), phone: '+51 977 111 222', email: 'rdiaz@scotiabank.pe', source: 'base', etapa: 'inactivo', priority: 'baja', assignedTo: 'u5', assignedToName: 'Roberto Silva', estimatedValue: 45000, createdAt: '2025-03-01', nextAction: 'Evaluar renovación', nextFollowUp: '', tags: ['banca'] },
];
...
export const opportunities: Opportunity[] = [
  { id: 'o1', title: 'Servicio Corporativo Minera Los Andes', contactId: 'l1', contactName: 'Pedro Castillo', amount: 45000, probability: 30, etapa: 'reunion_agendada', status: 'abierta', expectedCloseDate: '2026-04-15', assignedTo: 'u1', assignedToName: 'Carlos Mendoza', createdAt: '2026-03-01', description: 'Servicio de transporte ejecutivo para personal directivo' },
  { id: 'o2', title: 'Transporte Ejecutivo Hotel Belmond', contactId: 'l2', contactName: 'Sofía Vargas', amount: 38000, probability: 40, etapa: 'reunion_efectiva', status: 'abierta', expectedCloseDate: '2026-04-01', assignedTo: 'u2', assignedToName: 'María García', createdAt: '2026-02-28', description: 'Transfer aeropuerto-hotel para huéspedes VIP' },
  { id: 'o3', title: 'Flota Exclusiva BCP', contactId: 'l5', contactName: 'Fernando Ochoa', amount: 120000, probability: 70, etapa: 'negociacion', status: 'abierta', expectedCloseDate: '2026-03-30', assignedTo: 'u1', assignedToName: 'Carlos Mendoza', createdAt: '2026-02-15', description: 'Contrato anual para ejecutivos del banco' },
  { id: 'o4', title: 'Contrato Embajada España', contactId: 'l7', contactName: 'Ricardo Flores', amount: 85000, probability: 100, etapa: 'activo', status: 'ganada', expectedCloseDate: '2026-03-01', assignedTo: 'u3', assignedToName: 'José Ramírez', createdAt: '2026-01-20', description: 'Servicio diplomático premium' },
  { id: 'o5', title: 'Transporte Clínica Internacional', contactId: 'l4', contactName: 'Laura Mendez', amount: 55000, probability: 50, etapa: 'propuesta_economica', status: 'abierta', expectedCloseDate: '2026-04-10', assignedTo: 'u4', assignedToName: 'Ana Torres', createdAt: '2026-02-20', description: 'Traslado de personal médico y directivos' },
  { id: 'o6', title: 'Plan Universitario PUCP', contactId: 'l6', contactName: 'Patricia Huamán', amount: 35000, probability: 70, etapa: 'negociacion', status: 'abierta', expectedCloseDate: '2026-03-25', assignedTo: 'u2', assignedToName: 'María García', createdAt: '2026-02-10', description: 'Transporte para docentes y autoridades' },
  { id: 'o7', title: 'Southern Copper Premium', contactId: 'l11', contactName: 'Andrés Paredes', amount: 150000, probability: 30, etapa: 'reunion_agendada', status: 'abierta', expectedCloseDate: '2026-05-01', assignedTo: 'u2', assignedToName: 'María García', createdAt: '2026-02-22', description: 'Transporte ejecutivo para operaciones Lima-mina' },
  { id: 'o8', title: 'Repsol Corporate Fleet', contactId: 'l14', contactName: 'Isabella Campos', amount: 110000, probability: 70, etapa: 'negociacion', status: 'abierta', expectedCloseDate: '2026-04-20', assignedTo: 'u5', assignedToName: 'Roberto Silva', createdAt: '2026-02-05', description: 'Servicio de transporte para plantas y oficinas' },
  { id: 'o9', title: 'Alicorp Ejecutivo', contactId: 'l13', contactName: 'Martín Delgado', amount: 42000, probability: 50, etapa: 'propuesta_economica', status: 'abierta', expectedCloseDate: '2026-04-05', assignedTo: 'u4', assignedToName: 'Ana Torres', createdAt: '2026-02-12', description: 'Plan ejecutivo para directores regionales' },
  { id: 'o10', title: 'Interbank VIP', contactId: 'l10', contactName: 'Valentina Rojas', amount: 95000, probability: 10, etapa: 'contacto', status: 'abierta', expectedCloseDate: '2026-05-15', assignedTo: 'u1', assignedToName: 'Carlos Mendoza', createdAt: '2026-03-02', description: 'Servicio premium para alta dirección' },
];
