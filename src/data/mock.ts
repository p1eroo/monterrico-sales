...
export const users: User[] = [
  { id: 'u1', name: 'Carlos Mendoza', email: 'carlos.mendoza@taximonterrico.com', role: 'admin', phone: '+51 999 111 222', status: 'activo', contactsAssigned: 45, opportunitiesActive: 12, salesClosed: 28, conversionRate: 62, joinedAt: '2023-01-15' },
  { id: 'u2', name: 'María García', email: 'maria.garcia@taximonterrico.com', role: 'gerente', phone: '+51 999 333 444', status: 'activo', contactsAssigned: 38, opportunitiesActive: 9, salesClosed: 22, conversionRate: 58, joinedAt: '2023-03-20' },
  { id: 'u3', name: 'José Ramírez', email: 'jose.ramirez@taximonterrico.com', role: 'asesor', phone: '+51 999 555 666', status: 'activo', contactsAssigned: 32, opportunitiesActive: 7, salesClosed: 18, conversionRate: 56, joinedAt: '2023-06-10' },
  { id: 'u4', name: 'Ana Torres', email: 'ana.torres@taximonterrico.com', role: 'asesor', phone: '+51 999 777 888', status: 'activo', contactsAssigned: 28, opportunitiesActive: 8, salesClosed: 15, conversionRate: 54, joinedAt: '2023-08-01' },
  { id: 'u5', name: 'Roberto Silva', email: 'roberto.silva@taximonterrico.com', role: 'asesor', phone: '+51 999 999 000', status: 'activo', contactsAssigned: 25, opportunitiesActive: 5, salesClosed: 12, conversionRate: 48, joinedAt: '2024-01-15' },
